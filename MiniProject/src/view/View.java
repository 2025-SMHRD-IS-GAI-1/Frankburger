...
public class View {
	...
	public void statusLogin(MemberVO loginVO) {
		if (loginVO != null) {
			...
			System.out.println("tip1: 낚시터마다 출현하는 배스크기와 확률이 다르므로");
			System.out.println("낚시터 확률을 꼭 확인하세요!");
			System.out.println("tip2: 날씨가 폭우일 때는 평소보다 잡을 확률이 20% 감소됩니다.");
	...
	public void getFishingSpotInfo(LinkedHashMap<String, Integer> fishChances) {
		...
		System.out.println("════════════════════════════════════════════════");
		System.out.println("┌──────┬──────────┬────────┬──────────┐");
		System.out.println("│ Size │ Catch %  │ Score  │   Gold   │");
		System.out.println("├──────┼──────────┼────────┼──────────┤");
		System.out.println("│ S    │   100%   │ 10 pts │   100G   │");
		System.out.println("│ M    │   50%    │ 25 pts │   120G   │");
		System.out.println("│ L    │   25%    │ 60 pts │   150G   │");
		System.out.println("│ Boss │   10%    │ 500 pts│  5000G   │");
		System.out.println("└──────┴──────────┴────────┴──────────┘");
	}
	...
	public void showGoodEnding() {
		System.out.println("최고의 낚싯대를 손에 쥔 홍길동, 마침내 전설의 배스를 낚아 올렸다.");
